...
<div class="col-md-10 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
          ...
          <a href="{{route('admin.section.add')}}"  class="btn btn-info float-right my-3"> Add Section</a>
                ...
                @if (!empty($items))
                    @foreach($items as $item)
                      <tr>
                        ...
                        @if($item->status == '1')
                            <td>
                                <a class="updateItemStatus" id="item-{{$item->id}}" direction="section" item-id="{{$item->id}}" href="javascript:void(0)">
                        ...
                        <td class="d-flex">
                            ...
                            <a class="confirm-delete"  id="{{ $item->id }}" data-title="section"   title="delete section">
